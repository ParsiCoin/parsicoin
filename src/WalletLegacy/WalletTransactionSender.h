...
{
public:
  WalletTransactionSender(const Currency& currency, INode& node, WalletUserTransactionsCache& transactionsCache, AccountKeys keys, ITransfersContainer& transfersContainer);
