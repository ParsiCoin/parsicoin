...
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = DIFFICULTY_TARGET * 500;
...
const uint64_t MINIMUM_FEE                                   = 100000; // for now Minimum fee would be 0.001 for a while 
...
const uint32_t UPGRADE_HEIGHT_V2                             = 27500;
...
const std::initializer_list<CheckpointData> CHECKPOINTS = { 
  ...
  {26800,	"4072a07d9701112e68b75a9441f7113562f7bfadcaa49b4d71c91163e554c108" },
};
