...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "PARS";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "PARS";
    ...
    const std::string daemonName = "parsicoind";
    ...
    const std::string coinName = "ParsiCoin";

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "https://t.me/parsicoin";
